                      ...
                      <div className='flex flex-col space-y-6'>
                        ...
                        <Controller
                          ...
                          render={({ field }) => (
                            <Checkbox.Card
                              {...field}
                              className={`relative p-6 bg-opacity-50 ${field.value
                        ...
                        <Controller
                          ...
                          render={({ field }) => (
                            <Checkbox.Card
                              {...field}
                              className={`relative p-6 bg-opacity-50 ${field.value ? 'bg-green-600 border-green-300 text-white' : 'bg-gray-200 text-gray-800'
                                } hover:bg-green-600 dark:hover:bg-blue-600 cursor-pointer rounded-lg transition-all duration-200 ease-in-out shadow-lg`}
                              radius='md'
                              checked={!!field.value}
                              onClick={() => {
            ...
            <div className='lg:col-span-2 lg:col-start-4'>
              <form className='p-10 rounded bg-white shadow-sm' onSubmit={onSubmit} noValidate>
                ...
                <div className='flex justify-between'>
                  <div className='mt-3'>
                    <a className='text-blue hover:text-cyan-400 hover:cursor-pointer'>Quên mật khẩu?</a>
                  </div>
                  <div></div>
                </div>
          ...
          <div className='lg:col-span-2 lg:col-start-4'>
            <div className='p-10 rounded bg-white shadow-sm'>
              ...
              <div className='flex flex-col items-center space-x-4 p-4 bg-white rounded-lg shadow-md'>
                ...
                <br />
                  <QrCode value={qrCodeGenerator(deviceInfo)} handleRefreshQrCode={() => handleRefreshQrCode} containLogo={true} code={code} />
                <br />
